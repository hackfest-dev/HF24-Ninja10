...
<div className="relative block overflow-hidden rounded-lg bg-blue-100" style={{ height: '150%', width: 'calc(50% - 8px)', marginTop: '20px', marginBottom: '20px' }}>
   <div className="px-6 py-12 rounded-lg mb-4">
    <div className="font-bold text-xl mb-4"> Paid Appointment</div> 
